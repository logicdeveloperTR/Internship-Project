    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEmployeeHeads", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2023, 10, 9, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProjectLeaders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEmployeeHeadList", x => new { x.EmployeeId, x.HeadId });
                    table.ForeignKey(
                        name: "FK_AppEmployeeHeadList_AppEmployeeHeads_HeadId",
                        column: x => x.HeadId,
                        principalTable: "AppEmployeeHeads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEmployeeHeadList_AppEmployees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLeaderList", x => new { x.ProjectId, x.LeaderId });
                    table.ForeignKey(
                        name: "FK_AppLeaderList_AppProjectLeaders_LeaderId",
                        column: x => x.LeaderId,
                        principalTable: "AppProjectLeaders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppLeaderList_AppProjects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEmployeeHeadList_EmployeeId_HeadId",
                table: "AppEmployeeHeadList",
                columns: new[] { "EmployeeId", "HeadId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppEmployeeHeadList_HeadId",
                table: "AppEmployeeHeadList",
                column: "HeadId");

            migrationBuilder.CreateIndex(
                name: "IX_AppLeaderList_LeaderId",
                table: "AppLeaderList",
                column: "LeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_AppLeaderList_ProjectId_LeaderId",
                table: "AppLeaderList",
                columns: new[] { "ProjectId", "LeaderId" });
